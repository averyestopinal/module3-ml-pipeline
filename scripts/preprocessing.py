...
numeric_cols = ["Number.of.Bags", "Category.One.Defects", "Category.Two.Defects", "Aroma", "Flavor", "Aftertaste", "Acidity", "Body", "Balance", "Uniformity", "Clean.Cup", "Sweetness", "Cupper.Points", "Total.Cup.Points", "Moisture",
...
def preprocess(train_df, test_df, numeric_cols, categorical_cols):
    ...
    X_train_df.to_csv("data/cleaned/X_train_clean.csv", index=False)
    X_test_df.to_csv("data/cleaned/X_test_clean.csv", index=False)
