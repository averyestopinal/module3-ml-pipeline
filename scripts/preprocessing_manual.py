...
"Certification.Contact", "unit_of_measurement" are stored as strings.
"""

# Owner is missing 7 entries. Owner should have no impact on coffee quality, represented by Total.Cup.Points. Therefore, this column can be dropped.
